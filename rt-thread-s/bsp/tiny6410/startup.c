...
/*@{*/
	...
	rt_uint8_t _irq_stack_start[CONFIG_STACKSIZE*2];
	rt_uint8_t _fiq_stack_start[CONFIG_STACKSIZE*2];
	rt_uint8_t _undefined_stack_start[CONFIG_STACKSIZE];
	rt_uint8_t _abort_stack_start[CONFIG_STACKSIZE];
	rt_uint8_t _svc_stack_start[CONFIG_STACKSIZE*2];
...
#ifdef __CC_ARM
	rt_system_heap_init((void*)&Image$$ER_ZI$$ZI$$Limit, (void*)(0x0FFF0000));
#else
	rt_system_heap_init((void*)&__bss_end, (void*)0x0FFF0000);
#endif
